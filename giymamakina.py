...
coded by:swantex
       _                                         _    _             
  __ _(_)_   _ _ __ ___   __ _   _ __ ___   __ _| | _(_)_ __   __ _ 
 / _` | | | | | '_ ` _ \ / _` | | '_ ` _ \ / _` | |/ / | '_ \ / _` |
| (_| | | |_| | | | | | | (_| | | | | | | | (_| |   <| | | | | (_| |
 \__, |_|\__, |_| |_| |_|\__,_| |_| |_| |_|\__,_|_|\_\_|_| |_|\__,_|
 |___/   |___/                                                      
...
instagram:swantexofc 
    ...
    try:
        while True:
            banner()
            print(Fore.GREEN+Style.BRIGHT+"1."+Style.RESET_ALL+Fore.YELLOW+" spam 1"+Fore.GREEN+Style.BRIGHT+"\n2."+Style.RESET_ALL+Fore.YELLOW+" spam 2 "+Fore.GREEN+Style.BRIGHT+"\n3."+Style.RESET_ALL+Fore.YELLOW+" ÇIKIŞ")
            opt=str(input(Fore.RED+Style.BRIGHT+"\n>>> "+Fore.RESET))
            if opt=='1':
                domain=str(input(Fore.CYAN+Style.BRIGHT+"kullanıcı adı url sal!:"+Fore.RESET))
        ...
        port =int(input(Fore.CYAN+Style.BRIGHT+"spam adedi(çok fazla girme cihazın çöker amina)  : "+Fore.RESET))

        print(Fore.YELLOW+Style.BRIGHT+"başlangıç...."+Style.RESET_ALL)
        clearConsole()
        time.sleep(2)

        print(Fore.RED+Back.LIGHTGREEN_EX+"HELE ŞÜKÜR EĞLENCE BAŞLIYO AQ"+Style.RESET_ALL)
        for i in tqdm(range(30000)):
    ...
    try:
        while True:
            ...
            print(color_random+"SPAM  %s ADEDİNDE %s HEDEFE :%s" % (sent, ip, port))
            if port==65534:
                port=1
            elif port==1900:
                port=1901
